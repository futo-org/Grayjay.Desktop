...
namespace Grayjay.ClientServer
{
    public interface IWindowProvider
    {
        ...
        Task<IWindow> CreateInterceptorWindowAsync(string title, string url, string userAgent, bool useMobileEmulation, Action<InterceptorRequest> handler, CancellationToken cancellationToken = default);
