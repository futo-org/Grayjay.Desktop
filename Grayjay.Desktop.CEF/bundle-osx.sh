...
mkdir -p bin/Release/net8.0/osx-x64/publish/wwwroot
cp -r ../Grayjay.Desktop.Web/dist bin/Release/net8.0/osx-x64/publish/wwwroot/web
...
cp -a bin/Release/net8.0/osx-x64/publish/Grayjay.Desktop.CEF Grayjay.app/Contents/MacOS
cp -a bin/Release/net8.0/osx-x64/publish/libe_sqlite3.dylib Grayjay.app/Contents/MacOS
cp -a bin/Release/net8.0/osx-x64/publish/libsodium.dylib Grayjay.app/Contents/MacOS
cp -a bin/Release/net8.0/osx-x64/publish/ClearScriptV8.osx-x64.dylib Grayjay.app/Contents/MacOS
cp -a bin/Release/net8.0/osx-x64/publish/wwwroot Grayjay.app/Contents/MacOS/wwwroot

cp -a bin/Release/net8.0/osx-x64/publish/dotcefnative.app/Contents/Frameworks Grayjay.app/Contents

cp -a Resources/MacOS/Keychain.framework Grayjay.app/Contents/Frameworks/Keychain.framework
cp -a bin/Release/net8.0/osx-x64/publish/dotcefnative.app/Contents/Resources Grayjay.app/Contents
cp -a Resources/MacOS/grayjay.icns Grayjay.app/Contents/Resources/shared.icns
cp -a bin/Release/net8.0/osx-x64/publish/dotcefnative.app/Contents/MacOS/dotcefnative Grayjay.app/Contents/MacOS
